...
- **DO NOT** edit, modify, or commit changes to files within submodule directories (e.g., `RT-DETRv4/`, `chicken-detection-labelme-format/`)
...
uv run python RT-DETRv4/train.py -c RT-DETRv4/configs/rtv4/rtv4_hgnetv2_s_coco.yml

# Or activate venv and run normally
source .venv/bin/activate
python RT-DETRv4/train.py -c RT-DETRv4/configs/rtv4/rtv4_hgnetv2_s_coco.yml
```
