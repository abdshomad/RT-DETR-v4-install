#!/usr/bin/env python3
"""
Train RT-DETRv4-X (X-Large) model on chicken detection dataset.

Usage:
    python train-rt-detr-v4-x.py [--use-amp] [--seed SEED] [--resume PATH] [--tune PATH] [--test-only]
"""
...
def main():
    """Main training function for RT-DETRv4-X."""
    parser = argparse.ArgumentParser(
        description="Train RT-DETRv4-X model on chicken detection dataset",
    ...
    config_path = (configs.PROJECT_ROOT / configs.CONFIG_PATHS["x"]).resolve()
